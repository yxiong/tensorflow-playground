...
node {
  name: "xentropy/reduction_indices"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  ...
  op: "Sum"
  input: "mul"
  input: "xentropy/reduction_indices"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "global-step/initial_value"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "global-step/Assign"
  op: "Assign"
  input: "global-step"
  input: "global-step/initial_value"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/xentropy_grad/Shape"
  op: "Shape"
  input: "mul"
  attr {
    key: "T"
...
node {
  name: "gradients/xentropy_grad/Size"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/xentropy_grad/add"
  op: "Add"
  input: "xentropy/reduction_indices"
  input: "gradients/xentropy_grad/Size"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/xentropy_grad/mod"
  op: "Mod"
  input: "gradients/xentropy_grad/add"
  input: "gradients/xentropy_grad/Size"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/xentropy_grad/Shape_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/xentropy_grad/range/start"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/xentropy_grad/range/delta"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/xentropy_grad/range"
  op: "Range"
  input: "gradients/xentropy_grad/range/start"
  input: "gradients/xentropy_grad/Size"
  input: "gradients/xentropy_grad/range/delta"
  attr {
    key: "Tidx"
    value {
      type: DT_INT32
...
node {
  name: "gradients/xentropy_grad/Fill/value"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/xentropy_grad/Fill"
  op: "Fill"
  input: "gradients/xentropy_grad/Shape_1"
  input: "gradients/xentropy_grad/Fill/value"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/xentropy_grad/DynamicStitch"
  op: "DynamicStitch"
  input: "gradients/xentropy_grad/range"
  input: "gradients/xentropy_grad/mod"
  input: "gradients/xentropy_grad/Shape"
  input: "gradients/xentropy_grad/Fill"
  attr {
    key: "N"
    value {
      i: 2
...
node {
  name: "gradients/xentropy_grad/Maximum/y"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/xentropy_grad/Maximum"
  op: "Maximum"
  input: "gradients/xentropy_grad/DynamicStitch"
  input: "gradients/xentropy_grad/Maximum/y"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/xentropy_grad/floordiv"
  op: "Div"
  input: "gradients/xentropy_grad/Shape"
  input: "gradients/xentropy_grad/Maximum"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/xentropy_grad/Reshape"
  op: "Reshape"
...
node {
  name: "gradients/xentropy_grad/Tile"
  op: "Tile"
  input: "gradients/xentropy_grad/Reshape"
  input: "gradients/xentropy_grad/floordiv"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  op: "Mul"
  input: "gradients/xentropy_grad/Tile"
  input: "Log"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/dropout_1/Div_grad/truediv"
  op: "Div"
...
node {
  ...
  op: "Sum"
  input: "gradients/dropout_1/Div_grad/truediv"
...
node {
  name: "gradients/dropout_1/Div_grad/Square"
  op: "Square"
  input: "dropout"
  attr {
    key: "T"
...
node {
  name: "gradients/dropout_1/Div_grad/truediv_1"
  op: "Div"
  input: "gradients/dropout_1/Div_grad/Neg"
  input: "gradients/dropout_1/Div_grad/Square"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  op: "Mul"
  input: "gradients/dropout_1/mul_grad/tuple/control_dependency"
  input: "gradients/dropout_1/Div_grad/truediv_1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
